...
class AddConstruccion extends React.Component {
	constructor (props) {
		super(props);
	...
	Add = () => {
		axios.post ('http://localhost:5001/api/construccion', 
		 {
			ID: this.state.ID,
...
<div className="main">
      <div className="one">
        <div className="register">
          <h3>Construccion: AGREGAR PRODUCTO</h3>
          <form >
            <div>
...
export default AddConstruccion;