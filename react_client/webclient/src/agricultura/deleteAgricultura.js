...
class DeleteAgricultura extends React.Component {
    constructor (props) {
        super(props);
    ...
    delete=()=>{
    axios.delete("http://localhost:5001/api/agricultura/"+this.state.Id)
    .then(response=>{
...
<div className="main">
      <div className="one">
        <div className="register">
          <h3>Agricultura: ELIMNAR PRODUCTO</h3>
          <form >
            <div>
...
export default DeleteAgricultura;